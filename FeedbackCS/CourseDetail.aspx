<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseDetail.aspx.cs" Inherits="FeedbackCS.CourseDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row bar">
            <div class="col-md-9">
                <a style="margin-left: 40px; margin-top: 20px;">ADD COURSE</a>
            </div>
        ...
        <div class="row" style="margin-top: 130px">
            <div class="col-md-7">
                ...
                <asp:Label ID="lblid" runat="server" Text="CourseID" CssClass="lbl"></asp:Label>
                <asp:TextBox ID="txtid" runat="server" CssClass="txt"></asp:TextBox><br />
                <br />

                <asp:Label ID="lblname" runat="server" Text="CourseName" CssClass="lbl"></asp:Label>
                <asp:TextBox ID="txtname" runat="server" CssClass="txt"></asp:TextBox><br />
                <br />

                <asp:Label ID="lblduration" runat="server" Text="Duration(Semester)" CssClass="lbl"></asp:Label>
                <asp:TextBox ID="txtduration" runat="server" CssClass="txt"></asp:TextBox><br />
                <br />
                <br />

                <asp:Button ID="btnadd" runat="server" Text="ADD" OnClick="btnadd_Click" CssClass="btn btn-primary btn2" />
                <asp:Button ID="btndelete" runat="server" Text="DELETE" OnClick="btndelete_Click" CssClass="btn btn-success btn2" />
                <asp:Button ID="btnupdate" runat="server" Text="UPDATE" OnClick="btnupdate_Click" CssClass="btn btn-warning btn2" />
                <asp:Button ID="btnexit" runat="server" Text="CANCEL" OnClick="btnexit_Click" CssClass="btn btn-danger btn2" /><br />
                <div style="margin-bottom:20%"></div>

            </div>
            <div class="col-md-5">
                <asp:GridView ID="coursegrid" ForeColor="Black" HeaderStyle-HorizontalAlign="Center" CssClass="grid gridheader" CellPadding="4" margin-right="1px" runat="server" ViewStateMode="Enabled" Width="457px" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" AllowSorting="True" Height="172px" AutoGenerateSelectButton="True" DataKeyNames="course_id" EnablePersistedSelection="True" OnSelectedIndexChanged="coursegrid_SelectedIndexChanged" SortedDescendingHeaderStyle-BorderStyle="Groove">
